...
namespace Infrastructure.Services
{
    public class PaymentService : IPaymentService
    {
        ...
        public async Task<CustomerBasket> CreateOrUpdatePaymentIntent(string basketId)
        {
            ...
            //loop over every basket item and check if the price is right, otherwise set it right.
            ...
            //update the basket with the current state of the basket(correct prices, payment intent and client secret)
